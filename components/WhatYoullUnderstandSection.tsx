      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-14 xl:gap-20">
          ...
          >
            ...
            <p className="mt-3 font-outfit text-[12px] leading-[1.8] text-[#000000]/60 sm:text-[13px] lg:text-[13px]">
                ...
                <div key={item.num}>
                  <AnimateOnScroll animation="fade-left" delay={i * 60}>
                    <div className="group flex items-center gap-4 rounded-xl px-2 py-4 transition-colors hover:bg-[#DDD5CA]/50 md:gap-5 md:py-5">
                      ...
                      {/* Number */}
                      <span className="w-8 shrink-0 font-outfit text-[11px] font-black tracking-[0.2em] text-[#D3BB71]">
                        {item.num}
                      </span>
                      ...
                      {/* Text */}
                      <p className="flex-1 font-outfit text-[13px] font-semibold leading-[1.55] text-[#000000] sm:text-[14px] lg:text-[14px] xl:text-[15px]">
                        {item.text}
                      </p>
                    </div>
                  </AnimateOnScroll>
            ...
            <AnimateOnScroll animation="fade-up" delay={480} className="mt-7 rounded-2xl bg-[#1D4231] p-5 md:mt-9 md:p-6">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="font-outfit text-[12px] text-[#D3BB71]/80 sm:text-[13px]">
