        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-14 xl:gap-20">
          ...
          >
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1D4231]/30 bg-[#DDD5CA]/60 px-3 py-1">
              <span
                className="material-symbols-outlined text-[12px] text-[#1D4231]"
            ...
            <p className="mt-3 font-body text-[12px] leading-[1.8] text-[#000000]/60 sm:text-[13px] lg:text-[13px]">
          ...
          <div className="flex-1">
                ...
                <div key={item.num}>
                  <AnimateOnScroll animation="fade-left" delay={i * 60}>
                    <div className="group flex items-center gap-4 rounded-xl px-2 py-4 transition-colors hover:bg-[#DDD5CA]/50 md:gap-5 md:py-5">
                      ...
                      {/* Number */}
                      <span className="w-8 shrink-0 font-body text-[11px] font-black tracking-[0.2em] text-[#D3BB71]">
                        {item.num}
                      </span>
                      ...
                      {/* Check icon */}
                      <span
                        className="material-symbols-outlined flex-shrink-0 text-[20px] text-[#1D4231]"
                        style={{ fontVariationSettings: '"FILL" 1' }}
                      >
                        check_circle
                      </span>
                      ...
                      {/* Text */}
                      <p className="flex-1 font-body text-[13px] font-semibold leading-[1.55] text-[#000000] sm:text-[14px] lg:text-[14px] xl:text-[15px]">
                        {item.text}
                      </p>
                    </div>
                  </AnimateOnScroll>
            ...
            <AnimateOnScroll animation="fade-up" delay={480} className="mt-7 rounded-2xl bg-[#1D4231] p-5 md:mt-9 md:p-6">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="font-body text-[14px] font-bold text-white sm:text-[15px]">
                    Not sure if you're eligible?
                  </p>
                  <p className="font-body text-[12px] text-[#D3BB71]/80 sm:text-[13px]">
