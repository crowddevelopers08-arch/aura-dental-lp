...
const faqItems = [
  {
    ...
    answer: 'You may experience mild pressure when switching to a new set of aligners, but this is temporary and indicates that your teeth are moving as planned.',
  },
  {
    question: 'How long does aligner treatment take?',
    answer: 'Treatment usually takes between 6 and 18 months, depending on the complexity of your case.',
  },
  {
    question: 'Can I eat while wearing aligners?',
    answer: 'No. Remove your aligners while eating or drinking anything other than water to keep them clean and maintain their clarity.',
  },
  {
  ...
  },
  {
    ...
    answer: 'The cost depends on the complexity of your treatment and the number of aligners required. Visit Aura Dental for a personalized consultation and treatment estimate.',
  },
];

export function AlignerFAQSection() {
