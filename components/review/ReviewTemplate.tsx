...
type ReviewTemplateProps = {
  /** Google review deep link for this branch. */
  googleReviewLink: string;
  /** Where a 1-3 star rating sends the patient. */
  feedbackHref: string;
  /** Optional branch name shown under the logo. */
  branchLabel?: string;
};

const GoogleIcon = () => (
  <svg viewBox="0 0 48 48" className="w-5 h-5 sm:w-6 sm:h-6" aria-hidden="true">
    <path
      fill="#EA4335"
...
export function ReviewTemplate({ googleReviewLink, feedbackHref, branchLabel }: ReviewTemplateProps) {
    ...
    <>
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto text-center">
          ...
          {branchLabel && (
            <p
              className="-mt-2 mb-4 sm:mb-6 text-sm sm:text-base font-semibold tracking-wide uppercase"
            ...
            <>
              ...
              >
                <button
                  ...
                  style={{ backgroundColor: BRAND }}
                >
                  <span className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-white flex items-center justify-center shrink-0">
                    <GoogleIcon />
                  </span>
