...
const implantTypes = [
  {
    id: 1,
    image: '/images/single-teeth_bbi4oe.png',
  ...
  {
    id: 2,
    image: '/images/multiple-teeth_wybcqo.png',
  ...
  {
    id: 3,
    image: '/images/full-mouth_n5dz0z.png',
  ...
  {
    id: 4,
    image: '/images/all-on-4_phowoo.png',
  ...
  {
    id: 5,
    image: '/images/implant_sx15wr.png',
    ...
    <div className="overflow-hidden rounded-2xl border border-[#1D4231]/10 bg-[#DDD5CA]/30 shadow-sm transition-colors hover:bg-[#DDD5CA]/60">
      ...
      <div className="p-5 md:p-6">
        <div className="mb-1.5 flex flex-wrap items-center gap-2">
          <h3 className="font-heading text-[14px] font-bold leading-snug text-[#1D4231] sm:text-[15px] lg:text-[16px]">
            {type.title}
          </h3>
          <span
            className="rounded-full px-2 py-0.5 font-body text-[10px] font-bold uppercase tracking-[0.12em] text-white"
            style={{ backgroundColor: type.highlightColor }}
          >
            {type.highlight}
          </span>
        </div>
        <p className="font-body text-[12px] leading-[1.7] text-[#000000]/65 sm:text-[13px] md:text-[14px]">
          {type.description}
        </p>
      </div>
    </div>
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <AnimateOnScroll animation="fade-down" className="mb-8 text-center md:mb-10">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1D4231]/30 bg-[#DDD5CA]/60 px-3 py-1">
            ...
            <span className="font-body text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1D4231] sm:text-[12px]">Implant Solutions</span>
          </span>
