        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[44%_56%] md:gap-12 lg:gap-16">
          ...
          <AnimateOnScroll animation="fade-right" className="hidden md:flex md:flex-col md:gap-4">
            <div className="overflow-hidden rounded-3xl">
              <div className="relative h-[480px] w-full lg:h-[540px]">
                <Image src="/images/Specialist_vvhs2o.png" alt="Dr. Siva Nagini Yalavarthi" fill className="object-cover object-center" sizes="(min-width: 1024px) 38vw, 44vw" priority />
              </div>
            </div>
          ...
          <AnimateOnScroll animation="fade-left" delay={100}>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1D4231]/20 bg-white px-3 py-1">
              ...
              <span className="font-body text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1D4231] sm:text-[12px]">Meet Our Dental Expert</span>
            </span>
            ...
            <div className="mb-5 overflow-hidden rounded-3xl md:hidden">
              <div className="relative h-[380px] w-full">
                <Image src="/images/Specialist_vvhs2o.png" alt="Dr. Siva Nagini Yalavarthi" fill className="object-cover object-center" sizes="100vw" />
              </div>
            </div>
