        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-14 xl:gap-20">
          ...
          <AnimateOnScroll animation="fade-right" className="lg:sticky lg:top-24 lg:w-[38%] lg:self-start xl:w-[36%]">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1D4231]/30 bg-[#DDD5CA]/60 px-3 py-1">
              ...
              <span className="font-body text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1D4231] sm:text-[12px]">Why Patients Trust Us</span>
            </span>
            ...
            <p className="mt-3 font-body text-[13px] leading-[1.8] text-[#000000]/60 sm:text-[14px]">
                ...
                <div key={item.num}>
                  <AnimateOnScroll animation="fade-left" delay={i * 60}>
                    <div className="group flex items-center gap-4 rounded-xl px-2 py-4 transition-colors hover:bg-[#DDD5CA]/50 md:gap-5 md:py-5">
                      <span className="w-8 shrink-0 font-body text-[12px] font-black tracking-[0.2em] text-[#D3BB71]">{item.num}</span>
                      <div className="h-7 w-px shrink-0 rounded-full bg-[#D3BB71]" />
                      <span className="material-symbols-outlined flex-shrink-0 text-[22px] text-[#1D4231]" style={{ fontVariationSettings: '"FILL" 1' }}>check_circle</span>
                      <p className="flex-1 font-body text-[14px] font-semibold leading-[1.55] text-[#000000] sm:text-[15px] xl:text-[16px]">
                        {item.text}
                      </p>
                    </div>
                  </AnimateOnScroll>
