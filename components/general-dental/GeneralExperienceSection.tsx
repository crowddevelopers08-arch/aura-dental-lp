...
const pillars = [
  { icon: 'verified_user',       text: 'Experienced Dental Professionals' },
  { icon: 'healing',             text: 'Evidence-Based Dental Care' },
  { icon: 'family_restroom',     text: 'Care for Patients of All Ages' },
  { icon: 'sentiment_satisfied', text: 'Patient-First Approach' },
  { icon: 'shield',              text: 'Safe & Minimally Invasive' },
  { icon: 'star',                text: 'Exceptional Clinical Results' },
] as const;

export function GeneralExperienceSection() {
  return (
        ...
        <AnimateOnScroll animation="fade-up" delay={80}>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:gap-4 lg:grid-cols-3">
            {pillars.map((pillar, index) => (
              <AnimateOnScroll key={pillar.text} animation="fade-up" delay={index * 50}>
