        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[44%_56%] md:gap-12 lg:gap-16">
          ...
          <AnimateOnScroll animation="fade-left" delay={100}>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1D4231]/20 bg-white px-3 py-1">
              <span className="material-symbols-outlined text-[13px] text-[#1D4231]" style={{ fontVariationSettings: '"FILL" 1' }}>
                verified
              </span>
            ...
            <p className="mb-5 font-body text-[13px] leading-[1.8] text-[#000000]/70 sm:text-[14px] md:text-[14px] lg:text-[15px]">
              With over <strong className="font-bold text-[#1D4231]">12 years of clinical experience</strong>, Dr. Siva Nagini Yalavarthi specializes in advanced dental implantology, prosthodontics, smile rehabilitation, and restorative dentistry. She is dedicated to providing minimally invasive, evidence-based dental care using the latest technology and globally accepted treatment protocols. Her focus is on restoring healthy, functional, and beautiful smiles while ensuring every patient receives personalized care and a comfortable treatment experience.
            </p>
