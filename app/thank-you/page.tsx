      ...
      <header className="w-full border-b border-[#1D4231]/10 bg-[#fffffff2] backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1280px] items-center justify-between px-4 py-4 sm:px-6 md:px-[80px] md:py-5">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[#1D4231] px-4 py-2 font-body text-[13px] font-semibold text-white transition-colors hover:bg-[#1D4231] sm:px-5 sm:py-2.5 sm:text-[14px]"
          >
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6 md:px-[80px] md:py-10 max-[470px]:py-6 lg:py-10">
        <div className="mx-auto w-full max-w-[640px] text-center">
          ...
          <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-full bg-[#1D4231]/10 md:h-24 md:w-24">
            <span
              className="material-symbols-outlined text-[46px] text-[#1D4231] md:text-[52px]"
          ...
          {/* Heading */}
          <h1 className="font-heading text-[34px] font-extrabold leading-[1.2] text-[#1A1A1A] sm:text-[42px] md:text-[48px]">
            You&rsquo;re All Set!
          </h1>
          <p className="mt-3 font-body text-[14px] font-semibold uppercase tracking-[0.14em] text-[#D3BB71]">
            Consultation Request Received
          </p>

          {/* Message */}
          <p className="mt-5 font-body text-[17px] leading-[1.8] text-[#000000]/70 md:text-[17px]">
            Thank you for choosing{' '}
            <span className="font-semibold text-[#1D4231]">Aura Dental</span>.
            Our implant specialist will reach out to you within{' '}
            <span className="font-semibold text-[#1A1A1A]">30 minutes</span> to confirm
            your consultation and understand your dental goals better.
          </p>

          {/* What happens next */}
          <div className="mt-10 rounded-[1.25rem] border border-[#1D4231]/10 bg-white p-6 text-left shadow-sm md:mt-12 md:p-8">
            <h2 className="mb-5 font-heading text-[12px] font-bold uppercase tracking-[0.18em] text-[#1D4231]">
              What Happens Next
            </h2>
              ...
              {[
                {
                  ...
                  desc: 'Our implant specialist will call you to confirm your appointment time and understand your dental concerns.',
                  iconBg: '#1D4231',
                },
                {
                  icon: 'medical_information',
                  title: 'Your Dental Consultation',
                  desc: 'A detailed discussion about your dental condition, X-ray analysis, treatment options, implant suitability, and goals.',
                  iconBg: '#D3BB71',
                },
                {
                  icon: 'verified',
                ...
                <li key={title} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-body text-[15px] font-semibold leading-[1.4] text-[#1A1A1A] md:text-[16px]">{title}</p>
                    <p className="mt-0.5 font-body text-[14px] leading-[1.6] text-[#000000]/60 md:text-[15px]">{desc}</p>
                  </div>
                </li>
              ))}
            </ul>
          ...
          {/* Contact nudge */}
          <p className="mt-10 font-body text-[14px] text-[#000000]/50">
            Need immediate assistance?{' '}
            <a href="tel:+917842871414" className="font-semibold text-[#1D4231] hover:underline">
              Call us now
            </a>
          </p>
        </div>
