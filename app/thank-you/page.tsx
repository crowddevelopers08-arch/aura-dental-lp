    ...
    <main className="min-h-screen bg-[#ffffff] flex flex-col">
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6 md:px-[80px] md:py-10 max-[470px]:py-6 lg:py-10">
        <div className="mx-auto w-full max-w-[640px] text-center">
          ...
          <p className="mt-3 font-outfit text-[13px] font-semibold uppercase tracking-[0.14em] text-[#D3BB71]">
            Consultation Request Received
          </p>

          {/* Message */}
          <p className="mt-5 font-outfit text-[16px] leading-[1.8] text-[#000000]/70 md:text-[17px]">
          ...
          <div className="mt-10 rounded-[1.25rem] border border-[#1D4231]/10 bg-white p-6 text-left shadow-sm md:mt-12 md:p-8">
            <h2 className="mb-5 font-outfit text-[11px] font-bold uppercase tracking-[0.18em] text-[#1D4231]">
              What Happens Next
            </h2>
              ...
              {[
                ...
                <li key={title} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 font-outfit text-[13px] leading-[1.6] text-[#000000]/60 md:text-[14px]">{desc}</p>
                  </div>
                </li>
              ))}
            </ul>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:mt-10">
            ...
            <Link
              href="/"
              className="flex w-full items-center justify-center gap-2 rounded-full border border-[#1D4231]/30 px-8 py-3.5 font-outfit text-[13px] font-semibold text-[#1D4231] transition-all hover:bg-[#1D4231]/5 sm:w-auto"
            >
          ...
          {/* Contact nudge */}
          <p className="mt-10 font-outfit text-[13px] text-[#000000]/50">
      ...
      <footer className="border-t border-[#1D4231]/10 px-4 py-6 text-center sm:px-6 md:px-[80px]">
        <p className="font-outfit text-[12px] italic text-[#000000]/40">
