...
// Pull the payer's details off the payment so the thank-you step can greet them
// without the client retyping what they just entered in checkout.
...
export async function POST(req: NextRequest) {
  ...
  // succeeded before we send the patient to the confirmation page.
